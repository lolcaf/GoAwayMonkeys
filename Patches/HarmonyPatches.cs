...
namespace GoAwayMonkeys.Patches;
...
public static class HarmonyPatches
{
    ...
    // see when the liv camera is ready
    [HarmonyPatch(typeof(GTLckController), "SetupCamera")]
    public class LCKCameraPatch
    {
        [HarmonyPostfix]
        public static void Postfix()
        {
            Plugin.Log.WriteLine("LCK camera said it is ready");
            Plugin.Instance.SetupLCKCamera();
        }
    }
